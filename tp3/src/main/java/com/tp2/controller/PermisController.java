...
public class PermisController extends ControllerHelper {
    ...
    private ResponseEntity renewPermis(@PathVariable String nas, @RequestParam(required = false) Permis.PermisType type) {
        ...
        try {
            ...
            return new ResponseEntity<>(UserData.asErrorMessage("Error while creating permit"), HttpStatus.OK);
        } catch (NonexistentUserException e) {
            return new ResponseEntity<>(UserData.asErrorMessage("User not found while creating permit"), HttpStatus.OK);
        } catch (InvalidPermisRequestException e) {
            return new ResponseEntity<>(UserData.asErrorMessage("Permit was not authorized"), HttpStatus.OK);
        }
